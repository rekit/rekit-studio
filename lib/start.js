...
const craPlugin = require('../src/features/plugin-cra/core');
craPlugin.root = `/Users/pwang7/workspace/rekit-studio/src/features/plugin-cra`;

rekit.core.plugin.addPlugin(craPlugin);
