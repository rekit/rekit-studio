...
function startDevServer(args) {
  ...
  if (args.pluginPrj) {
    ...
    config.entry.push(path.join(args.pluginPrj, 'src/index.js'));
    config.plugins.push(
      new AddAssetHtmlPlugin([{ filepath: paths.resolveApp('dev-dll/rsdevdll.js') }]),
      new CopyWebpackPlugin([{ from: paths.resolveApp('dev-dll/static'), to: 'static' }]),
    );
  }
  ...
  checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(port => {
      ...
      require('./configStudio')(devServer.listeningApp, devServer.app);
