...
function startDevServer(args) {
    ...
    if (!args.noDevDll) {
      config.plugins.push(
        new webpack.DllReferencePlugin({
          ...
          manifest: require(paths.devDllManifest),
        }),
        new AddAssetHtmlPlugin([{ filepath: paths.resolveApp('dev-dll/rsdevdll.js') }]),
  ...
  checkBrowsers(paths.appPath, isInteractive)
    .then(() => {
      ...
      console.log('app path: ', paths.appPath);
      devServer.app.use('/sss',express.static(paths.appPath)); // access files in project

      configPluginsServer(devServer.app);
